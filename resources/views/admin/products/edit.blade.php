                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea id="description" name="description" rows="4"
                                      class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-200 resize-none"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="price" name="price" value="{{ old('price', $product->price) }}"
                                   class="block w-full pl-12 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('price') border-red-300 @enderror"
                                   placeholder="0" min="0">
                        </div>
                        @error('price')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="stock" name="stock" value="{{ old('stock', $product->stock) }}"
                                   class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('stock') border-red-300 @enderror"
                                   placeholder="0" min="0">
                        </div>
                        @error('stock')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
