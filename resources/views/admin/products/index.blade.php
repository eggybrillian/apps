                ...
                <div class="px-6 py-4 bg-gradient-to-r from-green-500 to-green-600 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('admin.products.create') }}"
                           class="bg-white text-green-600 px-4 py-2 rounded-lg hover:bg-gray-50 transition duration-200 flex items-center">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150 cursor-pointer" data-url="{{ route('admin.products.show', $product) }}" onclick="window.location=this.dataset.url">
